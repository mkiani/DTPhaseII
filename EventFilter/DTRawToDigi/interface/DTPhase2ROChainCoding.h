#ifndef DTRawToDigi_DTPhase2ROChainCoding_h
#define DTRawToDigi_DTPhase2ROChainCoding_h

/** \class DTPhase2ROChainCoding
 *  A class for handling the DT Read-out chain for PhaseII upgrade
 *
 *  \author M.B. Kiani - INFN Torino
 */
...
public:
  ...
  DTPhase2ROChainCoding(): code(0) {}

  DTPhase2ROChainCoding(const int &  ddu, const int &  ros, 
  ...
  DTPhase2ROChainCoding(uint32_t code_): code(code_) {}
  
  /// Destructor
  virtual ~DTPhase2ROChainCoding() {}
